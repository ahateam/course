...
public class CollageController extends Controller{
	...
	public APIResponse addCollage(//
		...
		try (DruidPooledConnection conn = (DruidPooledConnection) dsRds.openConnection()) {
			return APIResponse.getNewSuccessResp(collageService.addCollage(conn, collageName,knowledge,electId,examId));
		}
	}
	...
	public APIResponse upCollage(
			@P(t = "课程大纲ID") Long Id,
			@P(t = "课程大纲名称") String CollageName,
			@P(t = "总学时") Float knowledge,
			@P(t = "课程性质") Byte electId,
			@P(t = "考核方式") Byte examId
